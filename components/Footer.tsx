      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold text-white mb-4">DevClub</h2>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/formacoes" className="hover:text-white transition-colors">
                  Formações
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:contato@devclub.com.br" className="hover:text-white transition-colors">
